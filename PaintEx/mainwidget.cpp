...
//    connect(shapeComboBox,SIGNAL(activated(int)),this,SLOT(ShowShape (int)));
    ...
    connect(shapeComboBox, activated_int, this, &MainWidget::ShowShape);
...
//    connect(penWidthSpinBox,SIGNAL(valueChanged(int)),this,SLOT (ShowPenWidth(int)));
    ...
    connect(penWidthSpinBox, valueChanged_int, this, &MainWidget::ShowPenWidth);
...
//    void (QComboBox:: * activated_int )(int) = &QComboBox::activated;
    connect(penStyleComboBox, activated_int, this, &MainWidget::ShowPenStyle);
...
//    connect(penCapComboBox,SIGNAL(activated(int)),this,SLOT(ShowPenCap (int)));
    connect(penCapComboBox, activated_int, this, &MainWidget::ShowPenCap);
...
//    connect(penJoinComboBox,SIGNAL(activated(int)),this,SLOT(ShowPenJoin (int)));
    connect(penJoinComboBox, activated_int, this, &MainWidget::ShowPenJoin);
...
//    connect(fillRuleComboBox,SIGNAL(activated(int)),this,SLOT (ShowFillRule()));
    connect(fillRuleComboBox, activated_int, this, &MainWidget::ShowFillRule);
...
//    connect(spreadComboBox,SIGNAL(activated(int)),this,SLOT (ShowSpreadStyle()));
    connect(spreadComboBox, activated_int, this, &MainWidget::ShowSpreadStyle);
...
//    connect(brushColorBtn,SIGNAL(clicked()),this,SLOT (ShowBrushColor()));
    connect(brushColorBtn, &QPushButton::clicked, this, &MainWidget::ShowBrushColor);
...
//    connect(brushStyleComboBox,SIGNAL(activated(int)),this,SLOT (ShowBrush(int)));
    connect(brushStyleComboBox, activated_int, this, &MainWidget::ShowBrush);
...
void MainWidget::ShowBrush(int value)
{
    ...
    {
        paintArea->setBrush(QBrush(QPixmap("Qt.png")));
    }
    else
    {
